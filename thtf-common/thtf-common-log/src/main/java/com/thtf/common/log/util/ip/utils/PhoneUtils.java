package com.thtf.common.log.util.ip.utils;
...
public class PhoneUtils {
    ...
    public String phoneBelongTo(String phone) {
        ...
        PhoneInfo phoneInfo = lookup(phone);

        if (phoneInfo.getProvince().equals(phoneInfo.getCity())) {
            return stringBuffer.append(phoneInfo.getCity()).toString();
        }
        stringBuffer.append(phoneInfo.getProvince())
                .append(phoneInfo.getCity());
